...
export const Register: React.FC<RegisterProps> = ({ onSwitchToLogin, onRegisterSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { user, error: authError } = await authService.register(email, password, fullName);
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 sm:p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-purple-600 rounded-2xl mb-3 sm:mb-4 shadow-lg">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-slate-800 mb-1 sm:mb-2">Join SwiftCollect</h1>
          <p className="text-slate-500 text-xs sm:text-sm">Create your collection account</p>
        </div>
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg p-5 sm:p-8">
          ...
          <div className="relative my-4 sm:my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-2 text-slate-500 font-semibold">OR SIGN UP WITH</span>
            </div>
          </div>
