...
import { Parcel, ParcelStatus, Hub, Notification } from './types';
...
export const MOCK_PARCELS: Parcel[] = [
  {
    ...
    estimatedArrival: 'Today, 10:30 AM',
    collectionPin: '492831',
    hubId: 'h1'
  },
  {
    id: '2',
    trackingNumber: 'SWIFT-88122',
    courier: 'DHL Logistics',
    sender: 'Apple Store',
    status: ParcelStatus.IN_TRANSIT,
    estimatedArrival: 'Tomorrow',
    collectionPin: '110293',
    hubId: 'h2'
  },
  {
    id: '3',
    trackingNumber: 'SWIFT-77334',
    courier: 'UPS',
    sender: 'Nike Official',
    status: ParcelStatus.PENDING,
    estimatedArrival: 'Friday, Oct 25',
    collectionPin: '556122',
    hubId: 'h1'
  }
];
...
export const MOCK_HUBS: Hub[] = [
  ...
  {
    id: 'h2',
    name: 'Northgate Collection Point',
    address: '455 Northern Blvd, Uptown',
    lat: 40.7589,
    lng: -73.9851,
    distance: '2.4 km',
    status: 'Limited'
...
export const Icons = {
  ...
  Send: ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><line x1="22" y1="2" x2="11" y2="13"/><polyline points="22 2 15 22 11 13 2 9 22 2"/></svg>
  ),
...
export const MOCK_NOTIFICATIONS: Notification[] = [
  {
    ...
    body: 'Your parcel SWIFT-99210 is ready for pickup at Downtown Central Hub.',
    time: '2 hours ago',
    read: false
  },
  {
    id: '2',
    title: 'New Parcel In Transit',
    body: 'Your order from Amazon Prime is on its way. Expected arrival: Tomorrow.',
    time: '5 hours ago',
    read: false
  },
  {
    ...
    body: 'Downtown Central Hub is now open with available lockers.',
    time: '1 day ago',
    read: true
  }
];
